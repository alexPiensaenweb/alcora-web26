...
const RESEND_API_KEY = "re_SBGwmq9q_5DV6ZAbPaQ7KTmRNmPZ5NnKg";
const EMAIL_FROM = "Alcora Salud Ambiental <noreply@tienda.alcora.es>";
...
const COMPANY_EMAILS = ["alex@piensaenweb.com"];
function escapeHtml(str) {
  return str.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;");
}
function buildPresupuestoHtml(data) {
...
function buildRegistroHtml(data) {
  return `
<!DOCTYPE html>
<html>
<head><meta charset="utf-8"></head>
...
export { COMPANY_EMAILS as C, buildPedidoHtml as a, buildPresupuestoHtml as b, buildRegistroHtml as c, sendMail as s };
